...
gulp.task('build-client-templates', (done) => {
  glob('./app/templates/**/*', (err, files) => {
    if (err) done(err)
...
gulp.task('build-client', ['build-client-bundles', 'build-client-scss', 'build-client-html', 'build-client-assets', 'build-client-templates'])

gulp.task('build-client-production', ['build-client-bundles', 'build-client-scss', 'build-client-html-production', 'build-client-assets', 'build-client-templates'])
...
gulp.task('package-windows', ['build-production'], () => {
  return gulp.src('./build/**')
    ...
    .pipe(zip.dest('T:/release/windows.zip'))
})
